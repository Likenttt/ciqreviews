...
HAS_ALL_DEVELOPER_APPS = False
for issue in issues:
    if issue.title == 'ALL_DEVELOPER_APPS':
        HAS_ALL_DEVELOPER_APPS = True
        issue = issues[0]
...
if not HAS_ALL_DEVELOPER_APPS:
    issue = repo.create_issue("ALL_DEVELOPER_APPS", "{}")
